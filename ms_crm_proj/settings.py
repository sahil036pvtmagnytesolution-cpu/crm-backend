"""
Django settings for ms_crm_proj project.
...
SECRET_KEY = 'django-insecure-3lq^3@yx6tysoyykz=yw8yl4=#y$o5d876x!k1$kg#vyhvr-yt'
...
WSGI_APPLICATION = 'ms_crm_proj.wsgi.application'
...
# Media uploads (contract attachments, etc.)
MEDIA_URL = "/media/"
